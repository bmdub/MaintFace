...
Module Module1
    ...
    Private Sub MaintFace_CommandReceived(ByVal sender As Object, ByVal e As CommandReceivedEventArgs)
        Console.WriteLine("Command: " & e.Command)
        e.Response = "ok"
    End Sub

    Private Sub My_Button_Pressed(ByVal sender As Object, ByVal e As ButtonPressedEventArgs)
        Console.WriteLine("Button pressed: " & e.ButtonName)
    End Sub

    Private Sub MaintFace_AuthenticateUser(ByVal sender As Object, ByVal e As AuthEventArgs)
