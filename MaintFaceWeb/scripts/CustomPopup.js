class CustomPopup {
    constructor(titleText, color, backgroundColor, z, x, y, width, height, padding = 10) {
        this.MainDiv = null;
        this.MouseX = 0;
        this.MouseY = 0;
        this.Disposed = false;
    ...
    AddListItem(text, hoverColor = null, hoverBackgroundColor = null) {
    ...
    SizeToContent(allowShrink = true) {
